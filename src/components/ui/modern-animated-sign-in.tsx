...
import { Eye, EyeOff, Calendar, ShoppingCart, Mail, BarChart3 } from 'lucide-react';
      ...
      <div className="relative">
        {logoUrl ? (
          <img 
            src={logoUrl} 
            alt="Logo" 
            className="pointer-events-none w-44 h-44 object-contain z-10"
          />
        ) : (
        ...
        {/* White fade at bottom only affecting the logo */}
        <div className='absolute bottom-0 left-0 right-0 h-0 bg-gradient-to-t from-gray-50 to-transparent pointer-events-none' />
      </div>
    ...
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          ...
          >
            {isLoading ? (
              <span className="h-5 w-5 border-2 border-white border-t-transparent rounded-full animate-spin mr-2 inline-block"></span>
            ) : null}
            {submitButton} &rarr;
            <BottomGradient />
          </button>
...
// ==================== Business Icons Array ====================

const businessIconsArray: IconConfig[] = [
  {
    component: () => <Calendar className="h-8 w-8 text-blue-500" />,
  ...
  {
    component: () => <ShoppingCart className="h-8 w-8 text-green-500" />,
    className: 'size-[40px] border-none bg-transparent',
    duration: 20,
    delay: 10,
    radius: 100,
  ...
  {
    component: () => <Mail className="h-10 w-10 text-purple-500" />,
  ...
  {
    component: () => <BarChart3 className="h-10 w-10 text-orange-500" />,
    className: 'size-[50px] border-none bg-transparent',
    radius: 210,
    duration: 20,
    delay: 20,
  ...
  {
    component: () => <Calendar className="h-6 w-6 text-indigo-500" />,
  ...
  {
    component: () => <ShoppingCart className="h-6 w-6 text-red-500" />,
    className: 'size-[30px] border-none bg-transparent',
    duration: 20,
    delay: 10,
    radius: 150,
  ...
  {
    component: () => <Mail className="h-10 w-10 text-cyan-500" />,
    className: 'size-[50px] border-none bg-transparent',
    radius: 270,
    duration: 20,
    path: false,
  ...
  {
    component: () => <BarChart3 className="h-10 w-10 text-pink-500" />,
    className: 'size-[50px] border-none bg-transparent',
    radius: 270,
    duration: 20,
    delay: 60,

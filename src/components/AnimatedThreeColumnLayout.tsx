...
function AnimatedThreeColumnLayout({ children, onEmailUpdate }: AnimatedThreeColumnLayoutProps) {
  ...
  useEffect(() => {
    if (panelGroupRef.current) {
      ...
      const timer = setTimeout(() => {
        const { sidebar, folders, emailList, content } = getOptimalLayout();
  ...
  const { sidebar: sidebarSize, folders: foldersSize, emailList: emailListSize, content: emailViewSize } = optimalLayout;
